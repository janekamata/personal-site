...
const work: Position[] = [
  ...
  },
  {
    ...
    summary:
      'As an undergraduate teaching assistant, I worked for a variety of courses ranging from Data Science, Information Analytics, Information Visualization, Program Design and Implementation, and Object-Oriented Design. Depending on the course, responsibilities range from creating assignments, grading, snd one-on-one office hours.',
    highlights: [
  ...
  },
  {
    ...
    startDate: '2024-01-9',
    endDate: '2024-08-29',
    summary: `As a Business System Analyst Co-op focused on Real Estate, I collaborated with my team to analyze, design, and implement technology solutions that enhance Real Estate business processes and drive operational efficiency for internal and external stakeholders.`,
    highlights: [
...

  {
    ...
    endDate: '2023-12-20',
    summary: `As a Learning Experience Design Assistant at Northeastern University's D'Amore-McKim School of Business Learning Design and Technology Group, I collaborated with faculty members to enhance course materials and develop engaging learning experiences.`,
    highlights: [
